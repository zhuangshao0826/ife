...
Edit.prototype = {
  ...
  reset: function (val) {
    ...
    if (this.eparent) {
      ...
      this.eparent.insertBefore(document.createTextNode(value), this.eparent.firstChi
      ld);
    }
  },
  ...
  setEdit: function (parent) {
    ...
    textNode.no
  del: function () {
    if this.eparent.removeChild(this.node);
      this.eparent = null;
    }
  }
}

const EDIT = new Edit();deValue = '';
